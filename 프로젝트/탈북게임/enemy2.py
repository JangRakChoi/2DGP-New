...
class IdleState:
    ...
    def draw(boy):
        if (boy.nowX > boy.x) :
            boy.image.clip_draw(int(boy.frame) * 77, 308, 76, 98, boy.x, boy.y)
        elif (boy.nowX <= boy.x):
            boy.image.clip_draw(int(boy.frame) * 77, 208, 76, 98, boy.x, boy.y)
...
class WalkState:
    ...
    def draw(boy):
        if (boy.nowX > boy.x) :
            boy.image.clip_draw(int(boy.frame) * 77, 103, 77, 103, boy.x, boy.y)
        elif (boy.nowX <= boy.x):
            boy.image.clip_draw(int(boy.frame) * 77, 0, 77, 103, boy.x, boy.y)
